...
{ 
    function getLunarCalendar($year, $month, $day) {
        ...
        // 根据阴历年获取生肖 
        $zodiac=array("null", "鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪"); 
        // 农历月份
        ...
        // 'yearname'=>$mten[$everymonth[$j][14]] . $mtwelve[$everymonth[$j][15]] . "(".$zodiac[$everymonth[$j][15]].")" . "年",
        'lunarmonth'=>$nlmon,
        'lunarday'=>$nlday,
        // 'week'=>$weekday[$cur_wday],
        'zodiac'=>$zodiac[$everymonth[$j][15]],
        );
